// from https://github.com/aviate-labs/icp-canister/blob/main/src/icp/Ledger.mo
module {
    public let CANISTER_ID : Text = "ryjl3-tyaaa-aaaaa-aaaba-cai"; // live mainnet canister id: https://forum.dfinity.org/t/where-can-i-find-the-canister-id-for-the-mainnet-ledger-canister/11599/3
